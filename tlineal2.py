...
parser.add_argument('-mr2', type=float, default=None, help='Omite el limite en magnitud para refstars de zparams y usa este')
...
mo = zn[ky][0].split('-')[0]    #Forma de los nombres de archivos
