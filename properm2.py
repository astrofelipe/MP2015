...
def mf_match(ep):
    ej2 = 'in2=%s values2="ID" ifmt2=ascii icmd2=\'keepcols "ID_1 X_2 Y_2"\' matcher=exact find=best join=1and2 out=./%s/%s ofmt=ascii progress=none' % (ep, match_master, ep.split('/')[-1].replace('.match','.mfma'))
